<div align="center">
  ...
  <h1>سؤال های جاوااسکریپت</h1>
</div>

> [توجه!]  
> این مخزن در سال 2019 ایجاد شده، بنابراین سؤالات ارائه شده در اینجا بر اساس نحو و رفتار جاوا اسکریپت در آن زمان است. از آنجایی که جاوا اسکریپت یک زبان دائماً در حال تکامل است، ویژگی های جدیدتری وجود دارد برای این زبان که در اینجا مطرح نشده است.

---

<p align="center">
💪از مقدماتی تا پیشرفته: تست کنید که چقدر جاوا اسکریپت را می دانید، دانش خود را کمی تازه کنید یا برای مصاحبه برنامه نویسی خود آماده شوید!🚀
من این مخزن را به طور مرتب با سوالات جدید به روز می کنم. من پاسخ ها را در بخش **collapsed sections** در زیر سؤالات اضافه کردم، به سادگی روی آنها کلیک کنید تا آن را گسترش دهید. این فقط برای سرگرمی است، موفق باشید!❤️
</p>

<p align="center">بامن در تماس باشید! 😊</p>
...
| با خیال راحت در پروژه ها استفاده کنید! 😃 از ارجاع دادن به این مخزن قدردانی می کنم، من سؤالات و توضیحات را ایجاد می کنم و جامعه برنامه نویسان به من کمک زیادی برای حفظ و بهبود آن می کند! 💪🏼 ممنون و لذت ببرید! |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
